...
class ModelSerializationTest {
    ...
    fun jsonToAnimeShortDetailsTest_objectCreatedFieldsAssignedCorrectly() {
        ...
        assertThat(animeShortDetails.posterUrl.original).isEqualTo("/system/animes/original/6505.jpg?1577456413")
        assertThat(animeShortDetails.posterUrl.preview).isEqualTo("/system/animes/preview/6505.jpg?1577456413")
        assertThat(animeShortDetails.posterUrl.x96).isEqualTo("/system/animes/x96/6505.jpg?1577456413")
        assertThat(animeShortDetails.posterUrl.x48).isEqualTo("/system/animes/x48/6505.jpg?1577456413")
    ...
    fun jsonToAnimeFullDetailsTest_objectCreatedFieldsAssignedCorrectly() {
        ...
        assertThat(animeFullDetails.posterUrl.original).isEqualTo("/system/animes/original/6505.jpg?1577456413")
        assertThat(animeFullDetails.posterUrl.preview).isEqualTo("/system/animes/preview/6505.jpg?1577456413")
        assertThat(animeFullDetails.posterUrl.x96).isEqualTo("/system/animes/x96/6505.jpg?1577456413")
        assertThat(animeFullDetails.posterUrl.x48).isEqualTo("/system/animes/x48/6505.jpg?1577456413")
        ...
        assertThat(animeFullDetails.genres[0].id).isEqualTo(4)
        assertThat(animeFullDetails.genres[0].englishName).isEqualTo("Comedy")
        assertThat(animeFullDetails.genres[0].russianName).isEqualTo("Комедия")
        assertThat(animeFullDetails.genres[1].id).isEqualTo(22)
        assertThat(animeFullDetails.genres[1].englishName).isEqualTo("Romance")
        assertThat(animeFullDetails.genres[1].russianName).isEqualTo("Романтика")
        assertThat(animeFullDetails.studios.size).isEqualTo(1)
        assertThat(animeFullDetails.studios[0].id).isEqualTo(341)
        assertThat(animeFullDetails.studios[0].name).isEqualTo("SamBakZa")
        assertThat(animeFullDetails.studios[0].filteredName).isEqualTo("SamBakZa")
    }
}